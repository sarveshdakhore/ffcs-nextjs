...
export default function RegisterPage() {
  ...
  useEffect(() => {
	...
	if (state.error == "User created successfully") {
		router.push('/login');
	}
  }, [state.isAuthenticated, router, state.error]);
        ...
        <div className="">
          ...
          <div className="text-center mb-4">
            <div className="d-flex justify-content-center align-items-center mb-3">
              ...
              <div>
                ...
                <p style={{ color: '#bdc3c7', margin: 0, fontSize: '0.9rem' }}>Create your account</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              />
              <small style={{ color: '#bdc3c7', fontSize: '0.8rem' }}>
            ...
            <div className="mb-4">
              <label htmlFor="confirmPassword" style={{ color: 'white', fontWeight: '500', marginBottom: '0.5rem', display: 'block' }}>
                Confirm Password
              </label>
              <input
                type="password"
